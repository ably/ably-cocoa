...
- (void)getForMessageSerial:(NSString *)messageSerial query:(ARTAnnotationsQuery *)query callback:(ARTPaginatedAnnotationsCallback)callback {
    //[_channel.restChannel.annotations getForMessageSerial...];
}

- (void)publish:(ARTAnnotation *)msg callback:(ARTAnnotationErrorCallback)callback {
    // TODO: implement
}

- (void)unpublish:(ARTAnnotation *)msg callback:(ARTAnnotationErrorCallback)callback {
    // TODO: implement
}
