...
- (void)publish:(ARTAnnotation *)msg messageSerial:(NSString *)messageSerial callback:(ARTAnnotationErrorCallback)callback {
    // TODO: implement
}

- (void)unpublish:(ARTAnnotation *)msg messageSerial:(NSString *)messageSerial callback:(ARTAnnotationErrorCallback)callback {
    // TODO: implement
}
