...
/**
 Maintains the state that an `ARTPubSubClient` instance needs in order to determine the duration to wait before retrying a connection. Wraps a sequence of `ARTRetrySequence` objects.
 */
