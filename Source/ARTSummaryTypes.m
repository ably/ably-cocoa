...
#pragma mark - ARTMessageAnnotations Extension

@implementation ARTMessageAnnotations (SummaryTypes)

- (nullable NSDictionary<NSString *, ARTSummaryClientIdList *> *)summaryDistinctV1 {
    return ARTSummaryDistinctV1(self.summary[@"reaction:distinct.v1"]);
}

- (nullable NSDictionary<NSString *, ARTSummaryClientIdList *> *)summaryUniqueV1 {
    return ARTSummaryUniqueV1(self.summary[@"reaction:unique.v1"]);
}

- (nullable NSDictionary<NSString *, ARTSummaryClientIdCounts *> *)summaryMultipleV1 {
    return ARTSummaryMultipleV1(self.summary[@"reaction:multiple.v1"]);
}
