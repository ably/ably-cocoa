...
/**
 * The URL of an endpoint that the SDK can use to determine whether or not the Internet connection is working. It is only necessary to specify a non-default value if the default endpoint is not expected to be reachable in a particular network setting.
 */
