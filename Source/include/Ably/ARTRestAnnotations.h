...
@class ARTRestChannel, ARTAnnotation, ARTMessage, ARTErrorInfo;
 ...
 * @param callback A success or failure callback function.
 */
- (void)publishForMessageSerial:(NSString *)messageSerial annotation:(ARTAnnotation *)annotation callback:(nullable ARTCallback)callback;
 ...
 * @param callback A success or failure callback function.
 */
- (void)deleteForMessage:(ARTMessage *)message annotation:(ARTAnnotation *)annotation callback:(nullable ARTCallback)callback;
 ...
 * @param callback A success or failure callback function.
 */
- (void)deleteForMessageSerial:(NSString *)messageSerial annotation:(ARTAnnotation *)annotation callback:(nullable ARTCallback)callback;
