...
ART_TRY_OR_MOVE_TO_FAILED_START(realtime) {
    ...
    if (self) {
        ...
        _messagesEventEmitter = [[ARTPublicEventEmitter alloc] initWithRest:_realtime.rest];
        _presenceEventEmitter = [[ARTPublicEventEmitter alloc] initWithRest:_realtime.rest];
