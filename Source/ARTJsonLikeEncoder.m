...
- (instancetype)initWithLogger:(ARTInternalLogHandler *)logger delegate:(id<ARTJsonLikeEncoderDelegate>)delegate {
    if (self = [super init]) {
        _rest = nil;
        _logger = logger;
        _delegate = delegate;
...
- (instancetype)initWithRest:(ARTRestInternal *)rest delegate:(id<ARTJsonLikeEncoderDelegate>)delegate logHandler:(ARTInternalLogHandler *)logHandler {
    if (self = [super init]) {
        _rest = rest;
        _logger = logHandler;
        _delegate = delegate;
