...
## [Tests] Run tests on tvOS 14.4 using sandbox environment
test_tvOS:
	ABLY_ENV="sandbox" NAME="ably-tvOS" bundle exec fastlane test_tvOS14_4
...
update_carthage_dependencies_ios:
	...
	./Scripts/carthage-with-workaround-for-issue-3019.sh update --use-xcframeworks --platform iOS --no-use-binaries

## [Carthage] Update dependencies for just tvOS
update_carthage_dependencies_tvos:
	$(info Updating Carthage dependencies for tvOS…)

	./Scripts/carthage-with-workaround-for-issue-3019.sh update --use-xcframeworks --platform tvOS --no-use-binaries
...
update_carthage_dependencies_macos:
	...
	./Scripts/carthage-with-workaround-for-issue-3019.sh update --use-xcframeworks --platform macOS --no-use-binaries
