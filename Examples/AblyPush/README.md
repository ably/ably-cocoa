...
- Hit "Activate" button, then hit "Print Token". You should see the printed value in the debug output window. You can also hit "Device Details" for additional check.
