...
class SummaryTypesTests: XCTestCase {
    ...
    func test__summaryFlagV1__parses_from_dictionary() {
        let dictionary: [String: Any] = [
            "total": 3,
            "clientIds": ["client1", "client2", "client3"]
        ]

        let summary = summaryFlagV1(dictionary)
    ...
    func test__summaryFlagV1__returns_nil_for_invalid_dictionary() {
        let invalidDictionary: [String: Any] = [
            "total": 3,
            "clientIds": [123, 456] // Invalid - should be strings
        ]

        let summary = summaryFlagV1(invalidDictionary)

        XCTAssertNil(summary)
    }

    func test__summaryFlagV1__with_clipped_property() {
        let dictionary: [String: Any] = [
            "total": 5,
    ...
    func test__summaryMultipleV1__parses_dictionary_of_summaries() {
        let dictionary: [String: Any] = [
            "like": [
                "total": 10,
                "clientIds": [
        ...
        let summaryDict = summaryMultipleV1(dictionary)
    ...
    func test__summaryMultipleV1__returns_nil_for_invalid_values() {
        let invalidDictionary: [String: Any] = [
            "like": [
                "total": 5,
                "clientIds": [
        ...
        let summaryDict = summaryMultipleV1(invalidDictionary)
    ...
    func test__summaryDistinctV1__parses_dictionary_of_summaries() {
        let dictionary: [String: Any] = [
            "like": [
                "total": 3,
                "clientIds": ["client1", "client2", "client3"]
        ...
        let summaryDict = summaryDistinctV1(dictionary)
    ...
    func test__summaryUniqueV1__parses_dictionary_of_summaries() {
        let dictionary: [String: Any] = [
            "reaction": [
                "total": 5,
        ...
        let summaryDict = summaryUniqueV1(dictionary)
    ...
    func test__summaryTotalV1__parses_from_dictionary() {
        let dictionary: [String: Any] = [
            "total": 42
        ]

        let summary = summaryTotalV1(dictionary)

        XCTAssertNotNil(summary)
        XCTAssertEqual(summary?.total, 42)
    }

    func test__summaryTotalV1__parses_string_number_from_dictionary() {
        let dictionary: [String: Any] = [
