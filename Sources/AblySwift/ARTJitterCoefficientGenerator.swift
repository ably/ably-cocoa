...
internal protocol ARTJitterCoefficientGenerator {
...
internal class ARTDefaultJitterCoefficientGenerator: NSObject, ARTJitterCoefficientGenerator {
    
    // swift-migration: original location ARTJitterCoefficientGenerator.m, line 6
    internal func generateJitterCoefficient() -> Double {
