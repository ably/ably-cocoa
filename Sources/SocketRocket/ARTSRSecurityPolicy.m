...
#import "ARTSRPinningSecurityPolicy.h"

NS_ASSUME_NONNULL_BEGIN

@interface ARTSRSecurityPolicy ()

@property (nonatomic, readonly) BOOL certificateChainValidationEnabled;

@end

@implementation ARTSRSecurityPolicy
