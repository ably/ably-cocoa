...
CFHTTPMessageRef ARTSRHTTPConnectMessageCreate(NSURLRequest *request,
                                            ...
                                            NSArray<NSString *> *_Nullable requestedProtocols)
{
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Host"), (__bridge CFStringRef)_ARTSRHTTPConnectMessageHost(url));
    ...
    NSString *basicAuthorizationString = ARTSRBasicAuthorizationHeaderFromURL(url);
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Origin"), (__bridge CFStringRef)ARTSRURLOrigin(url));
