...
@interface ARTSRTWebSocketOperation ()

@end

@implementation ARTSRTWebSocketOperation {
...
- (void)start;
{
    dispatch_async(dispatch_get_main_queue(), ^{
        _webSocket = [[ARTSRWebSocket alloc] initWithURLRequest:[NSURLRequest requestWithURL:_url]];
...
- (BOOL)waitUntilFinishedWithTimeout:(NSTimeInterval)timeout
{
    ...
    return ARTSRRunLoopRunUntil(^BOOL{
