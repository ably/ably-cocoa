...
```swift
 .package(url: "https://github.com/ably/ably-cocoa", from: "1.2.15"),
```
...
1. Get the code from GitHub [from the release page](https://github.com/ably/ably-cocoa/releases/tag/1.2.15), or clone it to get the latest, unstable and possibly underdocumented version: `git clone git@github.com:ably/ably-cocoa.git`
