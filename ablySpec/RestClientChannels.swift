...
class RestClientChannels: QuickSpec {
    override func spec() {
        ...
        let cipherParams = ARTCipherParams(algorithm: nil, key: nil, keyLength: 0, iv: nil)
            ...
            context("channels") {
                ...
                context("get") {
                    ...
                    it("should return a channel with the provided options") {
                        let options = ARTChannelOptions(encrypted: true, cipherParams: cipherParams)
                    ...
                    it("should replace the options on an existing channel when new ones are provided") {
                        ...
                        let newOptions = ARTChannelOptions(encrypted: true, cipherParams: cipherParams)
