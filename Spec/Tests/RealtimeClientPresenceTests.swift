    ...
    func test__078__Presence__enter__optional_data_can_be_included_when_entering_a_channel() {
        ...
        waitUntil(timeout: testTimeout) { done in
            ...
            channel1.attach { error in
                NSLog("1e5beffd-b21f-4281-85c9-b1b6ab02471d: in channel1.attach callback")
                expect(error).to(beNil())
                let partlyDone = AblyTests.splitDone(2, done: done)
                NSLog("1e5beffd-b21f-4281-85c9-b1b6ab02471d: before channel1.presence.subscribe(.enter)")
                channel1.presence.subscribe(.enter) { member in
                    NSLog("1e5beffd-b21f-4281-85c9-b1b6ab02471d: in channel1.presence.subscribe(.enter) callback")
                ...
                channel2.presence.enter(expectedData) { error in
                    NSLog("1e5beffd-b21f-4281-85c9-b1b6ab02471d: in channel2.presence.enter callback")
                    expect(error).to(beNil())
                    partlyDone()
                }
            }
