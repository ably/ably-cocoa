...
The vendored SocketRocket implementation in `Source/SocketRocket/` is exempt from this rule for now — its time-related code will be addressed when the WebSocket layer becomes test-injectable.
