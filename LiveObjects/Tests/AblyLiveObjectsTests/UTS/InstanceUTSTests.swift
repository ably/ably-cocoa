...
@Suite(.serialized)
final class InstanceUTSTests {
    // MARK: - RTINS3: id property returns objectId

    // objects/unit/RTINS3/id-returns-objectid-0 — RTINS3a (LiveObject -> objectId). RTINS3b (primitive
    ...
    // objects/unit/RTINS4/value-counter-0 — RTINS4b (counter -> value) and RTINS4c (primitive ->
    ...
    // objects/unit/RTINS5/get-wraps-entry-0 — RTINS5c (look up key, wrap in Instance; nil when absent).
    ...
    // objects/unit/RTINS6/entries-yields-instances-0 — RTINS6b. RTINS6c (non-map -> empty array) is
    ...
    // objects/unit/RTINS9/size-0 — RTINS9b (map -> entry count). RTINS9c (non-map -> null) is
    // compile-time-unrepresentable (DEV-1).
    @Test
    ...
    // objects/unit/RTINS10/compact-0 — RTINS10b (behaves like PathObject#compact on the wrapped value).
    @Test
    ...
    // objects/unit/RTINS12/set-delegates-0 — RTINS12c. Asserts the published MAP_SET operation (the
    ...
    // objects/unit/RTINS13/remove-delegates-0 — RTINS13c. Asserts the published MAP_REMOVE operation.
    @Test
    ...
    // objects/unit/RTINS14/increment-delegates-0 — RTINS14c. Asserts the published COUNTER_INC.
    @Test
    ...
    // objects/unit/RTINS14a/increment-default-0 — RTINS14a1 (amount defaults to 1). Asserts the
    ...
    // objects/unit/RTINS15/decrement-delegates-0 — RTINS15c. Decrement is increment with a negated
    ...
    // objects/unit/RTINS15a/decrement-default-0 — RTINS15a1 (amount defaults to 1 => published -1).
    @Test
    ...
    // objects/unit/RTINS16/subscribe-receives-events-0 — RTINS16d/e1/f/g. The update is driven by
    ...
    // objects/unit/RTINS16e2/subscription-event-message-0 — RTINS16e1/e2. The event carries both the
    ...
    // objects/unit/RTINS16f/subscribe-returns-subscription-0 — after `unsubscribe()` the listener must
