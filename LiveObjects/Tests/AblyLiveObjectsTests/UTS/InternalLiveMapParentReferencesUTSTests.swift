// @UTS objects/unit/internal_live_map.md
//
...
// `UTS/InternalLiveMapUTSTests.swift` (and the native `InternalDefaultLiveMapTests.swift`).
//
...
struct InternalLiveMapParentReferencesUTSTests {
