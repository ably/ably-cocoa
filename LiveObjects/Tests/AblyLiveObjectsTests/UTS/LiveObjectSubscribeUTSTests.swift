// @UTS objects/unit/live_object_subscribe.md
...
///   noop branch.
@Suite(.serialized)
final class LiveObjectSubscribeUTSTests {
    ...
    // objects/unit/RTLO4b/subscribe-receives-updates-0 — RTLO4b3/RTLO4b4c3a/RTLO4b7: a Subscription is
    ...
    // objects/unit/RTLO4b7/subscribe-returns-subscription-0 — RTLO4b7: `subscribe` returns a
    ...
    // objects/unit/RTLO4b7/subscription-unsubscribe-stops-delivery-0 — after `unsubscribe()`, subsequent
    ...
    // objects/unit/RTLO4b7/subscription-unsubscribe-idempotent-0 — calling `unsubscribe()` twice does not
    // throw.
    @Test
    ...
    // objects/unit/RTLO4b4c1/noop-no-trigger-0 — a number-less COUNTER_INC yields a `.noop` (RTLC9h) and
    ...
    // objects/unit/RTLO4b6/subscribe-no-side-effects-0 — subscribing must not mutate the channel state.
    ...
    // objects/unit/RTLO4b/subscribe-map-update-0 — a MAP_SET on the subscribed map fires its listener.
    @Test
    ...
    // objects/unit/RTLO4b4c3c/tombstone-deregisters-listeners-0 — an OBJECT_DELETE tombstone is delivered
    ...
    // objects/unit/RTLO4b4d/update-has-object-message-0 — RTLO4b4d/RTINS16e: the delivered event carries
    ...
    // objects/unit/RTLO4b4e/tombstone-flag-true-0 — a tombstoning event carries an OBJECT_DELETE action.
    @Test
    ...
    // objects/unit/RTLO4b4e/tombstone-flag-false-0 — a normal update carries a non-OBJECT_DELETE action.
    @Test
