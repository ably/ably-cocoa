// @UTS objects/unit/value_types.md
...
@Suite(.serialized)
final class ValueTypesUTSTests {
    // MARK: - RTLCV3: LiveCounter.create construction

    // objects/unit/RTLCV3/create-with-count-0 — RTLCV3a1/RTLCV3b (DEV-VT-1: `create(initialCount:)`,
    // count is Double).
    @Test
    ...
    // objects/unit/RTLCV3/create-default-zero-0 — omitted initialCount defaults to 0.
    @Test
    ...
    // objects/unit/RTLMV3/create-with-entries-0 — RTLMV3a1/RTLMV3b. Entries are `LiveMapValue`; a bare
    ...
    // objects/unit/RTLMV3/create-no-entries-0 — omitted entries => internal entries is nil.
    @Test
    ...
    // objects/unit/RTLCV4/evaluate-generates-message-0 — RTLCV4c/d/f/g1–g4.
    @Test
    ...
    // objects/unit/RTLCV4g5/retains-local-counter-create-0 — the retained local CounterCreate is
    ...
    // objects/unit/RTLCV4/evaluate-zero-count-0 — count 0 is valid and retained.
    @Test
    ...
    // objects/unit/RTLMV4/evaluate-generates-message-0 — RTLMV4f/g/i/j1/j3/j4.
    @Test
    ...
    // objects/unit/RTLMV4j5/retains-local-map-create-0 — retained local MapCreate is
    ...
    // objects/unit/RTLMV4d/entry-value-types-0 — RTLMV4d3–d6 value-type -> data-field mapping.
    @Test
    ...
    // objects/unit/RTLMV4e2/empty-entries-0 — undefined internal entries => empty MapCreate.entries.
    @Test
    ...
    // objects/unit/RTLMV4d/map-set-all-types-table-0 — every supported value type maps to the correct
