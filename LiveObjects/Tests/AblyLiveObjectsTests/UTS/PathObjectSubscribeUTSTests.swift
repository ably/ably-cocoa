// @UTS objects/unit/path_object_subscribe.md
...
@Suite(.serialized)
final class PathObjectSubscribeUTSTests {
    ...
    // objects/unit/RTPO19/subscribe-receives-events-0 — RTPO19d/e1/e2: a Subscription is returned, the
    ...
    // objects/unit/RTPO19e1/event-path-object-correct-0 — RTPO19e1: the event's PathObject resolves to
    ...
    // objects/unit/RTPO19e2/event-message-delivery-0 — RTPO19e2/RTO24b2b2: the event's message copies
    ...
    // objects/unit/RTPO19e2/event-message-omitted-no-operation-0 — RTO4b2a: a sync-triggered update has
    ...
    // objects/unit/RTPO19b/subscribe-precondition-detached-0 — RTO25b: subscribe on a DETACHED/FAILED
    ...
    // objects/unit/RTPO19c1a/subscribe-non-positive-depth-throws-0 & subscribe-negative-depth-throws-0
    ...
    // objects/unit/RTPO19c1/subscribe-depth-1-self-only-0 — depth=1 covers only the exact path.
    @Test
    ...
    // objects/unit/RTPO19c1/subscribe-depth-2-children-0 — depth=2 covers self and one level of children.
    @Test
    ...
    // objects/unit/RTPO19c1/subscribe-unlimited-depth-0 — no depth: events at any depth.
    @Test
    ...
    // objects/unit/RTO24c1/depth-filtering-formula-0 — subPath prefix + depth-window formula: subscribe
    ...
    // objects/unit/RTO24c1/prefix-mismatch-0 — a subscription at "profile" ignores sibling changes.
    @Test
    ...
    // objects/unit/RTPO19d/subscribe-returns-subscription-0 — unsubscribe stops further delivery.
    @Test
    ...
    // objects/unit/RTPO19f/subscribe-follows-path-0 — after "score" is repointed to a new counter, the
    ...
    // objects/unit/RTPO19/subscribe-primitive-path-0 — a subscription on a primitive path fires when
    ...
    // objects/unit/RTPO19/map-clear-triggers-child-events-0 — MAP_CLEAR fans out to subscriptions.
    @Test
    ...
    // objects/unit/RTPO19/child-events-bubble-0 — child events bubble up to a parent subscription.
    @Test
    ...
    // objects/unit/RTO24b2a/candidate-paths-map-keys-0 — a MAP_SET on root with key "score" notifies
    ...
    // objects/unit/RTO24b2b/fires-once-per-dispatch-0 — a subscription covering multiple candidates
    ...
    // objects/unit/RTO24b1/multi-path-dispatch-0 — an object reachable via two paths notifies both.
    @Test
    ...
    // objects/unit/RTO24b2c/listener-exception-caught-0 — the spec's throwing-listener branch is
