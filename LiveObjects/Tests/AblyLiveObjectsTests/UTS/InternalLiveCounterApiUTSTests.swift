// @UTS objects/unit/internal_live_counter_api.md
...
@Suite(.serialized)
final class InternalLiveCounterApiUTSTests {
    // MARK: - RTLC5: value() returns current counter data

    // objects/unit/RTLC5/value-returns-data-0 — RTLC5c (returns current data value).
    @Test
    ...
    // objects/unit/RTLC12/increment-sends-counter-inc-0 — RTLC12e2/e3/e5/g. Asserts the published
    ...
    // objects/unit/RTLC12e1/increment-non-number-0 — the representable non-finite doubles throw 40003.
    @Test
    ...
    // objects/unit/RTLC12e1/increment-invalid-amounts-table-0 — every representable non-finite amount
    ...
    // objects/unit/RTLC13/decrement-negates-0 — RTLC13b. Asserts the negated published number (the
    ...
    // objects/unit/RTLC11/counter-update-on-inc-0 — RTLC11b1 (update carries the increment value). The
