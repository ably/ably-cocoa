// @UTS objects/unit/path_object_mutations.md
...
///   which throws 92007.
@Suite(.serialized)
final class PathObjectMutationsUTSTests {
    // MARK: - Fixture
    ...
    // objects/unit/RTPO15/set-delegates-to-map-0 — RTPO15d (delegates to InternalLiveMap#set). Asserts
    ...
    // objects/unit/RTPO15/set-nested-path-0 — RTPO15a2/RTPO15b (nested path resolves to the child map).
    @Test
    ...
    // objects/unit/RTPO15d/set-non-map-throws-0 — RTPO15e (set on a non-map -> 92007).
    @Test
    ...
    // objects/unit/RTPO16/remove-delegates-to-map-0 — RTPO16d (delegates to InternalLiveMap#remove).
    @Test
    ...
    // objects/unit/RTPO16d/remove-non-map-throws-0 — RTPO16e (remove on a non-map -> 92007).
    @Test
    ...
    // objects/unit/RTPO17/increment-delegates-to-counter-0 — RTPO17d (delegates to InternalLiveCounter#
    ...
    // objects/unit/RTPO17/increment-default-amount-0 — RTPO17a1 (amount defaults to 1).
    @Test
    ...
    // objects/unit/RTPO17d/increment-non-counter-throws-0 — RTPO17e (increment on a non-counter -> 92007).
    @Test
    ...
    // objects/unit/RTPO18/decrement-delegates-to-counter-0 — RTPO18d (decrement is increment with a
    ...
    // objects/unit/RTPO18/decrement-default-amount-0 — RTPO18a1 (amount defaults to 1 => published -1).
    @Test
    ...
    // objects/unit/RTPO18d/decrement-non-counter-throws-0 — RTPO18e (decrement on a non-counter -> 92007).
    @Test
    ...
    // objects/unit/RTPO3c2/set-unresolvable-throws-0 — RTPO3c2 (write on unresolvable path -> 92005/400).
    @Test
    ...
    // objects/unit/RTPO3c2/increment-unresolvable-throws-0 — RTPO3c2 (write on unresolvable path ->
    // 92005/400).
    @Test
