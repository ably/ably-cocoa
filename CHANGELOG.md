...
- Add support to get channel lifecycle status [\#1415](https://github.com/ably/ably-cocoa/issues/1415)
- Put all check jobs for each platform in a different GH workflow [\#1273](https://github.com/ably/ably-cocoa/issues/1273)
- Use `XCTUnwrap` instead of `guard/let/var` unwrap condition [\#1244](https://github.com/ably/ably-cocoa/issues/1244)

**Fixed bugs:**

- Mutable `ARTDeviceDetails.metadata` [\#1435](https://github.com/ably/ably-cocoa/issues/1435)
- Unique test channel names [\#1280](https://github.com/ably/ably-cocoa/issues/1280)

**Closed issues:**

- Multiple warnings generated by `jazzy` command: [\#1433](https://github.com/ably/ably-cocoa/issues/1433)
- Investigate failures in test case RealtimeClientPresenceTests test\_\_111\_\_Presence\_\_get\_\_Query\_\_set\_of\_params\_\_\_waitForSync\_is\_false\_\_should\_return\_immediately\_the\_known\_set\_of\_presence\_members \(ee46a8e6-e4ed-489c-83c7-648774930f92\) [\#1395](https://github.com/ably/ably-cocoa/issues/1395)
- Investigate failures in test case RealtimeClientConnectionTests skipped\_\_test\_\_094\_\_Connection\_\_Host\_Fallback\_\_should\_retry\_custom\_fallback\_hosts\_in\_random\_order\_after\_checkin\_if\_an\_internet\_connection\_is\_available [\#1362](https://github.com/ably/ably-cocoa/issues/1362)
- Remove call to `registerForRemoteNotifications` from Basic APNS example [\#1359](https://github.com/ably/ably-cocoa/issues/1359)
- Investigate failures in test case RealtimeClientConnectionTests test\_\_064\_\_Connection\_\_connection\_failures\_once\_CONNECTED\_\_if\_a\_Connection\_transport\_is\_disconnected\_unexpectedly\_or\_if\_a\_token\_expires\_\_then\_the\_Connection\_manager\_will\_immediately\_attempt\_to\_reconnect \(752111fe-1e41-4187-bddf-62cbfbece196\) [\#1337](https://github.com/ably/ably-cocoa/issues/1337)
- Investigate failures in test case RealtimeClientConnectionTests test\_\_092\_\_Connection\_\_Host\_Fallback\_\_should\_retry\_hosts\_in\_random\_order\_after\_checkin\_if\_an\_internet\_connection\_is\_available \(b747a0db-dfdb-497b-ab81-bddc93dbaf5a\) [\#1334](https://github.com/ably/ably-cocoa/issues/1334)
- Investigate failures in test case RealtimeClientPresenceTests test\_\_032\_\_Presence\_\_enter\_\_entering\_without\_an\_explicit\_PresenceMessage\_clientId\_should\_implicitly\_use\_the\_clientId\_of\_the\_current\_connection \(ac44f09c-f521-4bfc-a3d7-58d4f7428c74\) [\#1333](https://github.com/ably/ably-cocoa/issues/1333)
- Investigate failures in test case PushTests test\_\_008\_\_LocalDevice\_\_has\_a\_device\_method\_that\_returns\_a\_LocalDevice \(4f837671-6233-41f1-94e8-01174d1da7b8\) [\#1332](https://github.com/ably/ably-cocoa/issues/1332)
- Investigate failures in test case RealtimeClientPresenceTests test\_\_078\_\_Presence\_\_enter\_\_optional\_data\_can\_be\_included\_when\_entering\_a\_channel \(1e5beffd-b21f-4281-85c9-b1b6ab02471d\) [\#1331](https://github.com/ably/ably-cocoa/issues/1331)
- Split \#1279 into issues for multiple developers to work on [\#1323](https://github.com/ably/ably-cocoa/issues/1323)
- Document how to investigate test failures [\#1322](https://github.com/ably/ably-cocoa/issues/1322)
- Investigate failures in test case RealtimeClientPresenceTests test\_\_015\_\_Presence\_\_subscribe\_\_with\_no\_arguments\_should\_subscribe\_a\_listener\_to\_all\_presence\_messages \(84c9fbc5-8882-4010-ba99-3e44d1793397\) [\#1321](https://github.com/ably/ably-cocoa/issues/1321)
- Create simplified ably-cocoa example project for demonstrating push notifications capability [\#1318](https://github.com/ably/ably-cocoa/issues/1318)
- Investigate failures in test case RealtimeClientPresenceTests test\_\_037\_\_Presence\_\_update\_\_should\_update\_the\_data\_for\_the\_present\_member\_with\_a\_value \(114e01a8-8971-4c3a-9cb7-0bb128e2749e\) [\#1309](https://github.com/ably/ably-cocoa/issues/1309)
- According to spec, the SDK should be responsible for calling `-\[UIApplication registerForRemoteNotifications\]`, not the user [\#1271](https://github.com/ably/ably-cocoa/issues/1271)
- Missing properties in ARTErrorInfo [\#1261](https://github.com/ably/ably-cocoa/issues/1261)
- Missing properties in ARTClientOptions [\#1260](https://github.com/ably/ably-cocoa/issues/1260)
- Read and persist `state` returned in `ARTLocalDevice`/ `ARTDeviceDetails` [\#1162](https://github.com/ably/ably-cocoa/issues/1162)
- Conform ReadMe and create Contributing Document [\#1144](https://github.com/ably/ably-cocoa/issues/1144)
- Replace Carthage with SPM for Ably Project and test suite [\#1070](https://github.com/ably/ably-cocoa/issues/1070)
...
- Added missing `strong` property attributes [\#1434](https://github.com/ably/ably-cocoa/pull/1434) ([maratal](https://github.com/maratal))
- Fix `Scripts/set-version.sh` [\#1432](https://github.com/ably/ably-cocoa/pull/1432) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Jazzy docs generation workflow [\#1428](https://github.com/ably/ably-cocoa/pull/1428) ([maratal](https://github.com/maratal))
- 1352 cocoa update urls in readme [\#1427](https://github.com/ably/ably-cocoa/pull/1427) ([lukasz-szyszkowski](https://github.com/lukasz-szyszkowski))
- Add documentation about script for modifying GitHub workflows [\#1423](https://github.com/ably/ably-cocoa/pull/1423) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Add GCDTests and StringifiableTests to all platforms’ test suites [\#1422](https://github.com/ably/ably-cocoa/pull/1422) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Feature/1415 channel lifecycle status [\#1420](https://github.com/ably/ably-cocoa/pull/1420) ([maratal](https://github.com/maratal))
- Print observability server response body [\#1417](https://github.com/ably/ably-cocoa/pull/1417) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Fix channel name in RestClientPresenceTests.skipped\_\_test\_\_002 [\#1412](https://github.com/ably/ably-cocoa/pull/1412) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Remove outdated skipped test [\#1409](https://github.com/ably/ably-cocoa/pull/1409) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Fix mistake in my recent PR \#1332 [\#1404](https://github.com/ably/ably-cocoa/pull/1404) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- \(\#1395\) Fix failures in test case `RealtimeClientPresenceTests.test\_\_111\_\_Presence\_\_get\_\_Query\_\_set\_of\_params\_\_\_waitForSync\_is\_false\_\_should\_return\_immediately\_the\_known\_set\_of\_presence\_members` \(`ee46a8e6-e4ed-489c-83c7-648774930f92`\) [\#1403](https://github.com/ably/ably-cocoa/pull/1403) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- \(\#1332\) Fix crashes in test case `PushTests.test\_\_008\_\_LocalDevice\_\_has\_a\_device\_method\_that\_returns\_a\_LocalDevice` \(`4f837671-6233-41f1-94e8-01174d1da7b8`\) [\#1392](https://github.com/ably/ably-cocoa/pull/1392) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- \(\#1309, \#1321, \#1331, \#1333\) Fixes for 4 presence tests [\#1391](https://github.com/ably/ably-cocoa/pull/1391) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Premature disconnect to test reconnect within 10 seconds [\#1381](https://github.com/ably/ably-cocoa/pull/1381) ([maratal](https://github.com/maratal))
- \(\#1279\) Upload crash reports to test observability server [\#1377](https://github.com/ably/ably-cocoa/pull/1377) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Added XCTestExpectation to wait for all attemted fallback hosts \(test-094\) [\#1363](https://github.com/ably/ably-cocoa/pull/1363) ([maratal](https://github.com/maratal))
- Added XCTestExpectation to wait for all attemted fallback hosts \(test-092\) [\#1361](https://github.com/ably/ably-cocoa/pull/1361) ([maratal](https://github.com/maratal))
- Removed call to `registerForRemoteNotifications` from basic APNS example [\#1360](https://github.com/ably/ably-cocoa/pull/1360) ([maratal](https://github.com/maratal))
- Add documentation about tools for investigating test failures [\#1327](https://github.com/ably/ably-cocoa/pull/1327) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
...
- Basic APNS example [\#1319](https://github.com/ably/ably-cocoa/pull/1319) ([maratal](https://github.com/maratal))
- Fix test observability server upload on `main` [\#1308](https://github.com/ably/ably-cocoa/pull/1308) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Feature/1305 symmetric decryption [\#1307](https://github.com/ably/ably-cocoa/pull/1307) ([maratal](https://github.com/maratal))
- Feature/1261 missing cause in error info [\#1304](https://github.com/ably/ably-cocoa/pull/1304) ([maratal](https://github.com/maratal))
- Upload test results to observability server [\#1294](https://github.com/ably/ably-cocoa/pull/1294) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Call to the `registerForRemoteNotifications` [\#1293](https://github.com/ably/ably-cocoa/pull/1293) ([maratal](https://github.com/maratal))
- Make sure the iOS / tvOS versions used for running tests in CI are consistent between jobs [\#1291](https://github.com/ably/ably-cocoa/pull/1291) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Feature/1260 fallback retry timeout option [\#1290](https://github.com/ably/ably-cocoa/pull/1290) ([maratal](https://github.com/maratal))
- Make Git ignore `derived\_data` directory [\#1289](https://github.com/ably/ably-cocoa/pull/1289) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Don’t build Carthage libraries for unnecessary platforms [\#1288](https://github.com/ably/ably-cocoa/pull/1288) ([lawrence-forooghian](https://github.com/lawrence-forooghian))
- Fix/1280 unique test channel names [\#1282](https://github.com/ably/ably-cocoa/pull/1282) ([maratal](https://github.com/maratal))
- 1144 conform readme and creating contributing document [\#1275](https://github.com/ably/ably-cocoa/pull/1275) ([maratal](https://github.com/maratal))
- Split multiple jobs in one workflow to multiple workflows [\#1274](https://github.com/ably/ably-cocoa/pull/1274) ([maratal](https://github.com/maratal))
- XCTUnwrap instead of guard [\#1258](https://github.com/ably/ably-cocoa/pull/1258) ([maratal](https://github.com/maratal))
